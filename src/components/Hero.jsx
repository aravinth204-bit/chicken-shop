      ...
      <div className="relative max-w-7xl mx-auto px-4 py-12 md:py-20">
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-6 md:space-y-8">
            <div className="inline-flex items-center gap-2 bg-fire-red/20 border border-fire-red/30 rounded-full px-4 md:px-6 py-2">
            ...
            <p className="text-lg md:text-xl text-amber-100/70 max-w-xl mx-auto lg:mx-0">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center lg:justify-start">
              <a 
                href="#menu" 
                className="bg-fire-red hover:bg-red-700 text-white px-6 md:px-8 py-3 md:py-4 rounded-full font-bold text-base md:text-lg transition-all hover:scale-105 flex items-center justify-center gap-2"
              >
                View Products
            ...
            <div className="flex flex-wrap gap-4 md:gap-6 justify-center lg:justify-start pt-4">
